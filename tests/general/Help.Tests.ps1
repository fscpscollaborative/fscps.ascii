...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\fscps.ascii\functions", "$global:testroot\..\fscps.ascii\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\fscps.ascii\functions"
    "$global:testroot\..\fscps.ascii\internal\functions"
)
