...
$modules = @("PowerShellGet", "PSFramework", "PSScriptAnalyzer", "PSNotification")
...
& "$PSScriptRoot\..\fscps.ascii\tests\pester.ps1" -TestGeneral $TestGeneral -TestFunctions $TestFunctions -Exclude $Exclude